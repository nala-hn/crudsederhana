...
export default function GuestLayout({ children }) {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center bg-gray-100 sm:justify-center sm:pt-0">
            <Navbar className="fixed top-2 mx-auto z-40 max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
            ...
            <div className="w-full p-4 md:p-12 p-6 md:pt-24 bg-white min-h-screen">
                {children}
            </div>
